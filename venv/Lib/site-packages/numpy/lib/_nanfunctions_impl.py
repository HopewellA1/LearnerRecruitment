<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/_nanfunctions_impl.py
"""
...
def nanstd(a, axis=None, dtype=None, out=None, ddof=0, keepdims=np._NoValue,
    ...
    if isinstance(var, np.ndarray):
        ...
        std = np.sqrt(var)
    return std
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/_nanfunctions_impl.py
