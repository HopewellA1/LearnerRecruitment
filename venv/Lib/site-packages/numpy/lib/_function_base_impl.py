<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/_function_base_impl.py
import builtins
...
def digitize(x, bins, right=False):
    ...
    if mono == -1:
        ...
        return _nx.searchsorted(bins, x, side=side)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/_function_base_impl.py
