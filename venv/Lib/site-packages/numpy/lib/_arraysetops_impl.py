<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/_arraysetops_impl.py
"""
...
def setdiff1d(ar1, ar2, assume_unique=False):
    ...
    if assume_unique:
        ...
        ar2 = unique(ar2)
    return ar1[_in1d(ar1, ar2, assume_unique=True, invert=True)]
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/_arraysetops_impl.py
