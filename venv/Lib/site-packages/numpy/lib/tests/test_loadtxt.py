<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_loadtxt.py
"""
...
def test_maxrows_exceeding_chunksize(nmax):
    ...
    os.remove(fname)
    assert len(res) == nmax
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_loadtxt.py
