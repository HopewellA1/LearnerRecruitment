<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_format.py
# doctest
...
def test_metadata_dtype(dt, fail):
    ...
    if fail:
        ...
        assert drop_metadata(arr.dtype) is not arr.dtype
        assert drop_metadata(arr2.dtype) is arr2.dtype
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_format.py
