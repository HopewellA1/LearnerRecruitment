<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test__datasource.py
import os
import pytest
...
def test_del_attr_handling():
    ...
    # gracefully handles failed __init__:
    ds.__del__()
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test__datasource.py
