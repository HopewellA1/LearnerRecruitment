<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_ufunclike.py
import numpy as np
...
class TestUfunclike:
    ...
    def test_scalar(self):
        ...
        actual = np.fix(x, out=out)
        assert_(actual is out)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_ufunclike.py
