<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_mixins.py
import numbers
import operator
...
class TestNDArrayOperatorsMixin:
    ...
    def test_ufunc_two_outputs(self):
        ...
        _assert_equal_type_and_value(
            np.frexp(ArrayLike(np.array(2 ** -3))), expected)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_mixins.py
