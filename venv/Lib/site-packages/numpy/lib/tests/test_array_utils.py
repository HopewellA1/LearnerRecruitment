<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_array_utils.py
import numpy as np
...
class TestByteBounds:
    ...
    def test_strided(self):
        ...
        # stride), and compensate addresses for striding by 2
        assert_equal(high - low, b.size * 2 * b.itemsize - b.itemsize)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_array_utils.py
