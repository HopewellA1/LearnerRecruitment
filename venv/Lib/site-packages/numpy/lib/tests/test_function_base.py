<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_function_base.py
import operator
import warnings
import sys
import decimal
...
class TestSortComplex:
    ...
    def test_sort_complex(self):
        ...
        assert_equal(actual, expected)
        assert_equal(actual.dtype, expected.dtype)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_function_base.py
