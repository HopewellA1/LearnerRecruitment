<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_arrayterator.py
...
def test():
    ...
    # Check that all elements are iterated correctly
    assert_(list(c.flat) == list(d.flat))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_arrayterator.py
