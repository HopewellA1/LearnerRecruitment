<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_polynomial.py
import numpy as np
...
class TestPolynomial:
    ...
    def test_poly_coeffs_mutable(self):
        ...
        # APIs
        assert_raises(AttributeError, setattr, p, 'coeffs', np.array(1))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_polynomial.py
