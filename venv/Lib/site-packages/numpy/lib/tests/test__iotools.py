<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test__iotools.py
import time
...
class TestMiscFunctions:
    ...
    def test_flatten_dtype(self):
        ...
        dt_flat = flatten_dtype(dt)
        assert_equal(dt_flat, [float, float])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test__iotools.py
