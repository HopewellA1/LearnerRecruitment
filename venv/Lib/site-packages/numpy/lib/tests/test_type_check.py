<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/tests/test_type_check.py
import numpy as np
from numpy import (
...
class TestRealIfClose:
    ...
    def test_basic(self):
        ...
        b = real_if_close(a+1e-7j, tol=1e-6)
        assert_all(isrealobj(b))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/tests/test_type_check.py
