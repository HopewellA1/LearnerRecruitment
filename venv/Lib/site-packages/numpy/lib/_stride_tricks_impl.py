<<<<<<< HEAD:venv/Lib/site-packages/numpy/lib/_stride_tricks_impl.py
"""
...
def broadcast_arrays(*args, subok=False):
    ...
    *args : array_likes
    ...
    return tuple(_broadcast_to(array, shape, subok=subok, readonly=False)
                 for array in args)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/lib/_stride_tricks_impl.py
