<<<<<<< HEAD:venv/Lib/site-packages/numpy/polynomial/tests/test_hermite.py
...
class TestMisc:
    ...
    def test_weight(self):
        ...
        res = herm.hermweight(x)
        assert_almost_equal(res, tgt)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/polynomial/tests/test_hermite.py
