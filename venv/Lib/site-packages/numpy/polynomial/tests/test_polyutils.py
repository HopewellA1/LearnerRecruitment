<<<<<<< HEAD:venv/Lib/site-packages/numpy/polynomial/tests/test_polyutils.py
...
class TestDomain:
    ...
    def test_mapparms(self):
        ...
        res = pu.mapparms(dom1, dom2)
        assert_almost_equal(res, tgt)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/polynomial/tests/test_polyutils.py
