<<<<<<< HEAD:venv/Lib/site-packages/numpy/polynomial/tests/test_chebyshev.py
...
class TestMisc:
    ...
    def test_chebpts2(self):
        ...
        tgt = [-1.0, -0.707106781187, 0, 0.707106781187, 1.0]
        assert_almost_equal(cheb.chebpts2(5), tgt)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/polynomial/tests/test_chebyshev.py
