<<<<<<< HEAD:venv/Lib/site-packages/numpy/polynomial/tests/test_symbol.py
"""
...
def test_basis():
    p = poly.Polynomial.basis(3, symbol='z')
    assert_equal(p.symbol, 'z')
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/polynomial/tests/test_symbol.py
