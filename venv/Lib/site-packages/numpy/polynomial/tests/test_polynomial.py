<<<<<<< HEAD:venv/Lib/site-packages/numpy/polynomial/tests/test_polynomial.py
...
class TestMisc:
    ...
    def test_polyline_zero(self):
        assert_equal(poly.polyline(3, 0), [3])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/polynomial/tests/test_polynomial.py
