<<<<<<< HEAD:venv/Lib/site-packages/numpy/polynomial/tests/test_classes.py
    ...
    def test_approximation(self):
        ...
        for deg in range(0, 10):
            for t in range(0, deg + 1):
                p = Chebyshev.interpolate(powx, deg, domain=[0, 2], args=(t,))
                assert_almost_equal(p(x), powx(x, t), decimal=11)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/polynomial/tests/test_classes.py
