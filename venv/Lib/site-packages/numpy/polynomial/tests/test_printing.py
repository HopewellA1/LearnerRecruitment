<<<<<<< HEAD:venv/Lib/site-packages/numpy/polynomial/tests/test_printing.py
...
class TestPrintOptions:
    ...
    def test_non_finite(self):
        ...
        with printoptions(nanstr='NAN', infstr='INF'):
            ...
            assert p._repr_latex_() == \
                r'$x \mapsto \text{NAN} + \text{INF}\,x$'
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/polynomial/tests/test_printing.py
