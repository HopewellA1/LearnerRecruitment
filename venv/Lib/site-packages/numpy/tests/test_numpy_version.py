<<<<<<< HEAD:venv/Lib/site-packages/numpy/tests/test_numpy_version.py
"""
...
def test_version_module():
    ...
    assert contents == expected
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/tests/test_numpy_version.py
