<<<<<<< HEAD:venv/Lib/site-packages/numpy/tests/test_configtool.py
import os
import subprocess
import sysconfig
...
def test_configtool_pkgconfigdir():
    ...
    if not is_editable:
        ...
        # editable install, then it'll be hiding in the build dir)
        assert os.path.exists(os.path.join(stdout, 'numpy.pc'))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/tests/test_configtool.py
