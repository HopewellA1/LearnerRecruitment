<<<<<<< HEAD:venv/Lib/site-packages/numpy/tests/test_public_api.py
import sys
import sysconfig
import subprocess
import pkgutil
...
def test_functions_single_location():
    ...
    assert len(duplicated_functions) == 0, duplicated_functions
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/tests/test_public_api.py
