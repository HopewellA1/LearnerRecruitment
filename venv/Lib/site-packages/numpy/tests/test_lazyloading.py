<<<<<<< HEAD:venv/Lib/site-packages/numpy/tests/test_lazyloading.py
import sys
import importlib
...
def test_lazy_load():
    ...
    try:
        ...
        if old_numpy:
            sys.modules["numpy"] = old_numpy
            sys.modules.update(numpy_modules)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/tests/test_lazyloading.py
