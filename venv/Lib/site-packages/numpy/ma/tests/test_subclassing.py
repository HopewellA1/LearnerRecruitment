<<<<<<< HEAD:venv/Lib/site-packages/numpy/ma/tests/test_subclassing.py
...
class TestClassWrapping:
    ...
    def test_mixins_have_slots(self):
        ...
        wm = WrappedArray(m)
        assert_raises(AttributeError, wm.__setattr__, "not_an_attr", 2)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/ma/tests/test_subclassing.py
