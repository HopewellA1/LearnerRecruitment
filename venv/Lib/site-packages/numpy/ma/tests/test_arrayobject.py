<<<<<<< HEAD:venv/Lib/site-packages/numpy/ma/tests/test_arrayobject.py
import pytest
...
def test_matrix_transpose_equals_swapaxes(shape):
    ...
    tgt = np.swapaxes(arr, num_of_axes - 2, num_of_axes - 1)
    assert_array_equal(tgt, ma_arr.mT)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/ma/tests/test_arrayobject.py
