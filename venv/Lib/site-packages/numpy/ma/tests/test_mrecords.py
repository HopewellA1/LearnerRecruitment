<<<<<<< HEAD:venv/Lib/site-packages/numpy/ma/tests/test_mrecords.py
...
def test_record_array_with_object_field():
    ...
    # getting an item used to fail
    y[1]
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/ma/tests/test_mrecords.py
