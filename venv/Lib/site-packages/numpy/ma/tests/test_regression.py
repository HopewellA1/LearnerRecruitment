<<<<<<< HEAD:venv/Lib/site-packages/numpy/ma/tests/test_regression.py
import numpy as np
...
class TestRegression:
    ...
    def test_structured_array(self):
        ...
        np.ma.array((1, (b"", b"")),
                    dtype=[("x", np.int_),
                          ("y", [("i", np.void), ("j", np.void)])])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/ma/tests/test_regression.py
