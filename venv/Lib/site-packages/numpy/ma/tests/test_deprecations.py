<<<<<<< HEAD:venv/Lib/site-packages/numpy/ma/tests/test_deprecations.py
...
class TestFromtextfile:
    def test_fromtextfile_delimitor(self):
        ...
        with pytest.warns(DeprecationWarning):
            result = np.ma.mrecords.fromtextfile(textfile, delimitor=';')
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/ma/tests/test_deprecations.py
