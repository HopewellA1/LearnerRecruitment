<<<<<<< HEAD:venv/Lib/site-packages/numpy/random/_examples/cython/extending.pyx
#!/usr/bin/env python3
...
def bounded_uints(uint32_t lb, uint32_t ub, Py_ssize_t n):
    ...
    with x.lock, nogil:
        for i in range(n):
            out[i] = bounded_uint(lb, ub, rng)
    return np.asarray(out)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/random/_examples/cython/extending.pyx
