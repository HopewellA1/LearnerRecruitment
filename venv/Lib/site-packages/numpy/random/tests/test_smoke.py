<<<<<<< HEAD:venv/Lib/site-packages/numpy/random/tests/test_smoke.py
import pickle
...
class TestDefaultRNG(RNG):
    ...
    def test_seed(self):
        ...
        with pytest.raises(ValueError):
            np.random.default_rng([12345, -1])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/random/tests/test_smoke.py
