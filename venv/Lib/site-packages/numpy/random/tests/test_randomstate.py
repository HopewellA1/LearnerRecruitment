<<<<<<< HEAD:venv/Lib/site-packages/numpy/random/tests/test_randomstate.py
import hashlib
import pickle
import sys
import warnings
...
def test_swapped_singleton_against_direct(restore_singleton_bitgen):
    ...
    non_singleton_vals = rg.randint(0, 2 ** 30, 10)
    assert_equal(non_singleton_vals, singleton_vals)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/random/tests/test_randomstate.py
