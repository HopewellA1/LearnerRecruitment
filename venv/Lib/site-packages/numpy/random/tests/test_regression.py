<<<<<<< HEAD:venv/Lib/site-packages/numpy/random/tests/test_regression.py
import sys
...
class TestRegression:
    ...
    def test_permutation_subclass(self):
        ...
        assert_array_equal(perm, np.array([2, 1, 4, 0, 3]))
        assert_array_equal(m.__array__(), np.arange(5))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/random/tests/test_regression.py
