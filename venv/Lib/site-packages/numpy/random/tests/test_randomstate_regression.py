<<<<<<< HEAD:venv/Lib/site-packages/numpy/random/tests/test_randomstate_regression.py
import sys
...
def test_multinomial_1d_pval():
    ...
    with pytest.raises(TypeError, match="pvals must be a 1-d"):
        random.multinomial(10, 0.3)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/random/tests/test_randomstate_regression.py
