<<<<<<< HEAD:venv/Lib/site-packages/numpy/random/tests/test_seed_sequence.py
import numpy as np
...
def test_zero_padding():
    ...
    assert_array_compare(
        ...
        SeedSequence(42, spawn_key=(0,)).generate_state(4),
        expected42)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/random/tests/test_seed_sequence.py
