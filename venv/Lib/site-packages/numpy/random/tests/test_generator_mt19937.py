<<<<<<< HEAD:venv/Lib/site-packages/numpy/random/tests/test_generator_mt19937.py
import os.path
import sys
import hashlib
...
def test_legacy_pickle(version):
    ...
    assert state['state'] == 35399562948360463058890781895381311971
    assert state['inc'] == 87136372517582989555478159403783844777
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/random/tests/test_generator_mt19937.py
