<<<<<<< HEAD:venv/Lib/site-packages/numpy/random/tests/test_random.py
import warnings
...
class TestSingleEltArrayInput:
    ...
    def test_three_arg_funcs(self):
        ...
        for func in funcs:
            ...
            out = func(self.argOne, self.argTwo[0], self.argThree)
            assert_equal(out.shape, self.tgtShape)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/random/tests/test_random.py
