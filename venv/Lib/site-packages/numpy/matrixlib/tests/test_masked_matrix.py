<<<<<<< HEAD:venv/Lib/site-packages/numpy/matrixlib/tests/test_masked_matrix.py
import pickle
...
class TestConcatenator:
    ...
    def test_matrix(self):
        ...
        assert_equal(type(actual), type(expected))
        assert_equal(type(actual.data), type(expected.data))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/matrixlib/tests/test_masked_matrix.py
