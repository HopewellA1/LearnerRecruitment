<<<<<<< HEAD:venv/Lib/site-packages/numpy/matrixlib/tests/test_regression.py
import numpy as np
...
class TestRegression:
    ...
    def test_matrix_std_argmax(self):
        ...
        assert_equal(x.std().shape, ())
        assert_equal(x.argmax().shape, ())
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/matrixlib/tests/test_regression.py
