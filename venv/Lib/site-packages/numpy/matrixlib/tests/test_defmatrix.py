<<<<<<< HEAD:venv/Lib/site-packages/numpy/matrixlib/tests/test_defmatrix.py
...
class TestShape:
    ...
    def test_expand_dims_matrix(self):
        ...
        assert_equal(expanded.ndim, 3)
        assert_(not isinstance(expanded, np.matrix))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/matrixlib/tests/test_defmatrix.py
