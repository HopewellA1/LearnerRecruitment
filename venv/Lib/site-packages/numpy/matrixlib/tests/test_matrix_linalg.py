<<<<<<< HEAD:venv/Lib/site-packages/numpy/matrixlib/tests/test_matrix_linalg.py
...
class TestQRMatrix(_TestQR):
    array = np.matrix
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/matrixlib/tests/test_matrix_linalg.py
