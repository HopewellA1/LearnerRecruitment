<<<<<<< HEAD:venv/Lib/site-packages/numpy/linalg/tests/test_regression.py
...
class TestRegression:
    ...
    def test_matrix_rank_rtol_argument(self, rtol):
        ...
        res = np.linalg.matrix_rank(x, rtol=rtol)
        assert res.shape == (4,)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/linalg/tests/test_regression.py
