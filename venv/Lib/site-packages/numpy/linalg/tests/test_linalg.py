<<<<<<< HEAD:venv/Lib/site-packages/numpy/linalg/tests/test_linalg.py
...
def test_vector_norm():
    ...
    assert_equal(actual.shape, expected.shape)
    assert_almost_equal(actual, expected, double_decimal=3)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/linalg/tests/test_linalg.py
