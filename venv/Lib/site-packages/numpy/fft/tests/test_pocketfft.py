<<<<<<< HEAD:venv/Lib/site-packages/numpy/fft/tests/test_pocketfft.py
import numpy as np
import pytest
...
def test_fft_with_integer_or_bool_input(data, fft):
    ...
    expected = fft(float_data)
    assert_array_equal(result, expected)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/fft/tests/test_pocketfft.py
