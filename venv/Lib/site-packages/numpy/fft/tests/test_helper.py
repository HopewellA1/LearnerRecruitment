<<<<<<< HEAD:venv/Lib/site-packages/numpy/fft/tests/test_helper.py
...
class TestIRFFTN:
    ...
    def test_not_last_axis_success(self):
        ...
        # Should not raise error
        fft.irfftn(a, axes=axes)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/fft/tests/test_helper.py
