<<<<<<< HEAD:venv/Lib/site-packages/numpy/testing/tests/test_utils.py
import warnings
import sys
import os
import itertools
...
def test_xy_rename(assert_func):
    ...
    with pytest.warns(DeprecationWarning, match=dep_message), \
        ...
        assert_func(1, x=1)
        assert_func(1, 2, y=2)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/testing/tests/test_utils.py
