<<<<<<< HEAD:venv/Lib/site-packages/numpy/testing/print_coercion_tables.py
#!/usr/bin/env python3
...
if __name__ == '__main__':
    ...
    print("New casting type promotion:")
    print_new_cast_table(can_cast=True, legacy=True, flags=True)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/testing/print_coercion_tables.py
