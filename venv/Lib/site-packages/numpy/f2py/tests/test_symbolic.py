<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_symbolic.py
import pytest
...
class TestSymbolic(util.F2PyTest):
    ...
    def test_polynomial_atoms(self):
        ...
        assert (y(x) * x[y]).polynomial_atoms() == {y(x), x[y]}
        assert (y(x)**x).polynomial_atoms() == {y(x)}
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_symbolic.py
