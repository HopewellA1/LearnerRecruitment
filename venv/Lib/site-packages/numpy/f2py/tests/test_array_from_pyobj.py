<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_array_from_pyobj.py
import os
import sys
import copy
import platform
...
class TestSharedMemory:
    ...
    def test_inplace_from_casttype(self):
        for t in self.type.cast_types():
            ...
            assert not obj.flags["CONTIGUOUS"]
            assert obj.dtype.type is self.type.type  # obj changed inplace!
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_array_from_pyobj.py
