<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_character.py
import pytest
import textwrap
...
class TestBCCharHandling(util.F2PyTest):
    ...
    def test_gh25286(self):
        info = self.module.charint('T')
        assert info == 2
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_character.py
