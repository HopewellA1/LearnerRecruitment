<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_crackfortran.py
import importlib
import codecs
import time
import unicodedata
...
class TestParamEval():
    ...
    def test_param_eval_too_many_dims(self):
        ...
        pytest.raises(ValueError, crackfortran.param_eval, v, g_params, params,
                      dimspec=dimspec)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_crackfortran.py
