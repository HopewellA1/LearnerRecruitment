<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_assumed_shape.py
import os
import pytest
import tempfile
...
class TestF2cmapOption(TestAssumedShapeSumExample):
    ...
    def teardown_method(self):
        os.unlink(self.f2cmap_file.name)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_assumed_shape.py
