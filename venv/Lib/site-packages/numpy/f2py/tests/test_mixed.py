<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_mixed.py
import os
import textwrap
import pytest
...
class TestMixed(util.F2PyTest):
    ...
    def test_docstring(self):
        ...
        """)
        assert self.module.bar11.__doc__ == expected
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_mixed.py
