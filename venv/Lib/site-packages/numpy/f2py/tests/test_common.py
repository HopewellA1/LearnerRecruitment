<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_common.py
import pytest
import numpy as np
from . import util
...
class TestCommonWithUse(util.F2PyTest):
    ...
    def test_common_gh19161(self):
        assert self.module.data.x == 0
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_common.py
