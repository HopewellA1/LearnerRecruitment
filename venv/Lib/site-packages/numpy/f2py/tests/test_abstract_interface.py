<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_abstract_interface.py
...
class TestAbstractInterface(util.F2PyTest):
    ...
    def test_parse_abstract_interface(self):
        ...
        assert len(mod[0]["body"]) == 1
        assert mod[0]["body"][0]["block"] == "abstract interface"
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_abstract_interface.py
