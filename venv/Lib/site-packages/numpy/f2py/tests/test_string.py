<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_string.py
import os
import pytest
import textwrap
import numpy as np
...
class TestFixedString(util.F2PyTest):
    ...
    def test_intent_inout(self):
        for s in self._get_input(intent="inout"):
            ...
            # check that the rest of input string is preserved
            assert rest == self._sint(s, start=4)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_string.py
