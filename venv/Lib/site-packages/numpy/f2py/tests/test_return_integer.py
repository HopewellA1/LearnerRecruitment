<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_return_integer.py
import pytest
...
class TestFReturnInteger(TestReturnInteger):
    ...
    def test_all_f90(self, name):
        self.check_function(getattr(self.module.f90_return_integer, name),
                            name)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_return_integer.py
