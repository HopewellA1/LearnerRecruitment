<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_modules.py
import pytest
import textwrap
...
class TestUsedModule(util.F2PyTest):
    ...
    def test_gh25867(self):
        ...
        assert "mathops" in compiled_mods
        assert self.module.mathops.add(3, 7) == 10
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_modules.py
