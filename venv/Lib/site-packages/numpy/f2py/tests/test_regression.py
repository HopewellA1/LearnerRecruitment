<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/tests/test_regression.py
import os
import pytest
import platform
...
def test_gh25784():
    ...
    try:
        ...
        assert "unknown_subroutine_" in str(rerr)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/tests/test_regression.py
