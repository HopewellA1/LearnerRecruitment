<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/_backends/_meson.py
...
def _get_flags(fc_flags):
    ...
    unique_flags = list(dict.fromkeys(flag_values))
    return unique_flags
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/_backends/_meson.py
