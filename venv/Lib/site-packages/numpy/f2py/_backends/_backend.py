<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/_backends/_backend.py
...
class Backend(ABC):
    ...
    def compile(self) -> None:
        """Compile the wrapper."""
        pass
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/_backends/_backend.py
