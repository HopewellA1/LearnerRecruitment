<<<<<<< HEAD:venv/Lib/site-packages/numpy/f2py/_backends/_distutils.py
...
class DistutilsBackend(Backend):
    ...
    def compile(self):
        ...
        if self.remove_build_dir and os.path.exists(self.build_dir):
            print(f"Removing build directory {self.build_dir}")
            shutil.rmtree(self.build_dir)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/f2py/_backends/_distutils.py
