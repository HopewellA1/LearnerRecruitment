<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/fail/strings.pyi
import numpy as np
...
np.strings.replace(AR_U, b"_", b"-", 10)  # E: incompatible type
np.strings.replace(AR_S, "_", "-", 1)  # E: incompatible type
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/fail/strings.pyi
