<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/fail/histograms.pyi
import numpy as np
...
np.histogramdd(AR_i8, range=(0, 1))  # E: incompatible type
np.histogramdd(AR_i8, range=[(0, 1, 2)])  # E: incompatible type
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/fail/histograms.pyi
