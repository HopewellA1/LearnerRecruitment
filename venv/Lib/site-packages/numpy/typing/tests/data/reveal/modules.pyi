<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/modules.pyi
import sys
import types
...
assert_type(np.testing.__all__, list[str])
assert_type(f2py.__all__, list[str])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/modules.pyi
