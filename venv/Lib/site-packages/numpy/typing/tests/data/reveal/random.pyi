<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/random.pyi
import sys
import threading
...
assert_type(np.random.set_bit_generator(pcg64), None)
assert_type(np.random.get_bit_generator(), np.random.BitGenerator)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/random.pyi
