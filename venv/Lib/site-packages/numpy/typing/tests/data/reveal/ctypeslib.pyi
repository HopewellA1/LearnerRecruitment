<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/ctypeslib.pyi
import sys
import ctypes as ct
...
if sys.platform == "win32":
    ...
    assert_type(np.ctypeslib.as_ctypes(AR_long.take(0)), ct.c_long)
    assert_type(np.ctypeslib.as_ctypes(AR_ulong.take(0)), ct.c_ulong)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/ctypeslib.pyi
