<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/lib_function_base.pyi
import sys
...
assert_type(np.digitize(4.5, [1]), np.intp)
assert_type(np.digitize(AR_f8, [1, 2, 3]), npt.NDArray[np.intp])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/lib_function_base.pyi
