<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/array_constructors.pyi
import sys
...
if sys.version_info >= (3, 12):
    ...
    buffer: Buffer
    assert_type(create_array(buffer), npt.NDArray[Any])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/array_constructors.pyi
