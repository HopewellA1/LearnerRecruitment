<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/twodim_base.pyi
import sys
...
assert_type(np.triu_indices_from(AR_b), tuple[npt.NDArray[np.int_], npt.NDArray[np.int_]])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/twodim_base.pyi
