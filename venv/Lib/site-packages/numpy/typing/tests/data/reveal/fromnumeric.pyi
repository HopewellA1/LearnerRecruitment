<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/fromnumeric.pyi
...
assert_type(np.var(AR_f4, dtype=np.float64), np.float64)
assert_type(np.var(AR_f4, out=AR_subclass), NDArraySubclass)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/fromnumeric.pyi
