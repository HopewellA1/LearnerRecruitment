<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/strings.pyi
import sys
...
assert_type(np.strings.str_len(AR_U), npt.NDArray[np.int_])
assert_type(np.strings.str_len(AR_S), npt.NDArray[np.int_])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/strings.pyi
