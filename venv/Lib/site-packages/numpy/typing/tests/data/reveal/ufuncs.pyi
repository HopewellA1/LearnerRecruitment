<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/ufuncs.pyi
import sys
...
assert_type(np.bitwise_count(i8), Any)
assert_type(np.bitwise_count(AR_i8), npt.NDArray[Any])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/ufuncs.pyi
