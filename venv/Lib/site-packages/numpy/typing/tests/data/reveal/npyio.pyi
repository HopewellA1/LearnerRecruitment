<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/npyio.pyi
import re
import sys
import zipfile
import pathlib
...
assert_type(np.genfromtxt(str_path, ndmin=2), npt.NDArray[Any])
assert_type(np.genfromtxt(["1", "2", "3"], ndmin=2), npt.NDArray[Any])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/npyio.pyi
