<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/reveal/fft.pyi
import sys
...
assert_type(np.fft.fft2(AR_f8), npt.NDArray[np.complex128])
assert_type(np.fft.irfft2(AR_f8), npt.NDArray[np.float64])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/reveal/fft.pyi
