<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/pass/multiarray.py
import numpy as np
...
np.may_share_memory(1, 2)
np.may_share_memory(AR_f8, AR_f8, max_work=1)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/pass/multiarray.py
