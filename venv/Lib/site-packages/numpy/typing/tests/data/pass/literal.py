<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/pass/literal.py
...
for order_set, func in order_list:
    ...
    for order in invalid_orders:
        with pytest.raises(ValueError):
            func(order=order)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/pass/literal.py
