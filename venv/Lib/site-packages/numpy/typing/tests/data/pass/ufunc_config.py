<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/pass/ufunc_config.py
...
try:
    ...
    np.setbufsize(_bufsize_default)
    np.seterrcall(_errcall_default)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/pass/ufunc_config.py
