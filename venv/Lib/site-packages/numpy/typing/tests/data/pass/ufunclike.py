<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/pass/ufunclike.py
...
np.isneginf(AR_LIKE_f)
np.isneginf(AR_LIKE_f, out=AR_U)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/pass/ufunclike.py
