<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/pass/array_constructors.py
...
np.block([[C, C], [C, C]])
np.block(A)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/pass/array_constructors.py
