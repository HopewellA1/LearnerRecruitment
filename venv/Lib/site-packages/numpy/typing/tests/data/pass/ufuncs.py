<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/data/pass/ufuncs.py
import numpy as np
...
np.abs(np.array([1]))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/data/pass/ufuncs.py
