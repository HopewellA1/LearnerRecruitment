<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/test_runtime.py
...
class TestRuntimeProtocol:
    ...
    def test_issubclass(self, cls: type[Any], obj: object) -> None:
        ...
        assert issubclass(type(obj), cls)
        assert not issubclass(type(None), cls)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/test_runtime.py
