<<<<<<< HEAD:venv/Lib/site-packages/numpy/typing/tests/test_isfile.py
import os
import sys
...
class TestIsFile:
    def test_isfile(self):
        ...
        for file in FILES:
            assert_(os.path.isfile(file))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/typing/tests/test_isfile.py
