<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_longdouble.py
import warnings
import platform
import pytest
...
def test_eps_positive():
    ...
    # np._core.getlimits._discovered_machar didn't work properly
    assert np.finfo(np.longdouble).eps > 0.
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_longdouble.py
