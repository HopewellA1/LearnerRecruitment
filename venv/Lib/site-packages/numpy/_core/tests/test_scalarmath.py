<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_scalarmath.py
import contextlib
import sys
import warnings
import itertools
...
def test_scalar_matches_array_op_with_pyscalar(op, sctype, other_type, rop):
    ...
    if isinstance(val1, float) and other_type is complex and rop:
        ...
        assert res.dtype == expected.dtype
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_scalarmath.py
