<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_umath_complex.py
import sys
import platform
import pytest
...
class TestComplexAbsoluteMixedDTypes:
    ...
    def test_array(self, stride, astype, func):
        ...
        assert_array_max_ulp(h.real, g.real, 1)
        assert_array_max_ulp(h.imag, g.imag, 1)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_umath_complex.py
