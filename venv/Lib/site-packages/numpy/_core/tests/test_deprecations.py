<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_deprecations.py
"""
...
class TestDeprecatedDTypeParenthesizedRepeatCount(_DeprecationTestCase):
    ...
    def test_parenthesized_repeat_count(self, string):
        self.assert_deprecated(np.dtype, args=(string,))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_deprecations.py
