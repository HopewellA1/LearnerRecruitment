<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_machar.py
"""
    ...
    def test_underlow(self):
        ...
        with errstate(all='raise'):
            try:
                ...
                msg = "Caught %s exception, should not have been raised." % e
                raise AssertionError(msg)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_machar.py
