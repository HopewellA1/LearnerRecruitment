<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_indexerrors.py
import numpy as np
...
class TestIndexErrors:
    ...
    def test_methods(self):
        ...
        a = np.zeros((3, 3))
        assert_raises(IndexError, lambda: a.item(100))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_indexerrors.py
