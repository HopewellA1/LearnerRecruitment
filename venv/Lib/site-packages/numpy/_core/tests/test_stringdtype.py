<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_stringdtype.py
...
class TestImplementation:
    ...
    def test_arena_no_reuse_after_short(self):
        ...
        assert_array_equal(self.in_arena(c), False)
        assert_array_equal(self.is_on_heap(c), self.in_arena(self.a))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_stringdtype.py
