<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_records.py
...
def test_find_duplicate():
    ...
    l3 = [2, 2, 1, 4, 1, 6, 2, 3]
    assert_(np.rec.find_duplicate(l3) == [2, 1])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_records.py
