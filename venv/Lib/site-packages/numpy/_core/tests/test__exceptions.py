<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test__exceptions.py
"""
...
class TestAxisError:
    ...
    def test_pickling(self, args):
        ...
        for name in ("axis", "ndim", "args"):
            ...
            attr2 = getattr(exc2, name)
            assert attr1 == attr2, name
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test__exceptions.py
