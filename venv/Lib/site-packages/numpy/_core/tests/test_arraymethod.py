<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_arraymethod.py
"""
...
class TestClassGetItem:
    ...
    def test_subscript_tup(self, cls: type[np.ndarray], arg_len: int) -> None:
        ...
        if arg_len in (1, 2):
            ...
            with pytest.raises(TypeError, match=match):
                cls[arg_tup]
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_arraymethod.py
