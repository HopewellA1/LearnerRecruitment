<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_mem_overlap.py
import itertools
import pytest
...
class TestUFunc:
    ...
    def test_inplace_op_simple_manual(self):
        ...
        x += x.T
        assert_array_equal(x - x.T, 0)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_mem_overlap.py
