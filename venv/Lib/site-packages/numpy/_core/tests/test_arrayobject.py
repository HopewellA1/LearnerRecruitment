<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_arrayobject.py
import pytest
...
def test_matrix_transpose_equals_swapaxes(shape):
    ...
    mT = arr.mT
    assert_array_equal(tgt, mT)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_arrayobject.py
