<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_function_base.py
import sys
...
class TestAdd_newdoc:
    ...
    def test_errors_are_ignored(self):
        ...
        add_newdoc("numpy._core", "flatiter", ("index", "bad docstring"))
        assert prev_doc == np._core.flatiter.index.__doc__
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_function_base.py
