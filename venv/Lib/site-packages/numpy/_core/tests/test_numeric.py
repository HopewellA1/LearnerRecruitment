<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_numeric.py
import sys
import warnings
import itertools
import platform
...
class TestAsType:
    ...
    def test_astype(self):
        ...
        with pytest.raises(TypeError, match="Input should be a NumPy array"):
            np.astype(data, np.float64)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_numeric.py
