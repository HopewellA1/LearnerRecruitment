<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_array_coercion.py
"""
...
def test_empty_string():
    ...
    assert res.shape == (2, 10)
    assert res.dtype == "S1"
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_array_coercion.py
