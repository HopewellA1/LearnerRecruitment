<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_defchararray.py
import pytest
...
def test_empty_indexing():
    ...
    s = np.char.chararray((4,))
    assert_(s[[]].size == 0)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_defchararray.py
