<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_protocols.py
import pytest
import warnings
import numpy as np
...
def test_array_called():
    ...
    assert arr.dtype == 'U100'
    assert arr[0] == Wrapper.val
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_protocols.py
