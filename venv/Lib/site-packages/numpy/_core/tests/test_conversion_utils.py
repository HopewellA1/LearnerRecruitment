<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_conversion_utils.py
"""
...
class TestIntpConverter:
    ...
    def test_too_many_dims(self):
        ...
        with pytest.raises(ValueError):
            self.conv([1]*65)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_conversion_utils.py
