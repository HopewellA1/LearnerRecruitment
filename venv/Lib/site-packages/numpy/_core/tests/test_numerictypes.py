<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_numerictypes.py
import sys
import itertools
...
class TestBoolDefinition:
    def test_bool_definition(self):
        assert nt.bool is np.bool
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_numerictypes.py
