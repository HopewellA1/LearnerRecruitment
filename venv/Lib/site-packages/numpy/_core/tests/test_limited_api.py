<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_limited_api.py
import os
import shutil
import subprocess
import sys
...
def test_limited_api(install_temp):
    ...
    import limited_api_latest  # Latest version (current Python)
    import limited_api2  # cython
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_limited_api.py
