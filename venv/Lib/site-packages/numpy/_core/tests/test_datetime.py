<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_datetime.py
import datetime
import pickle
...
def test_comparisons_return_not_implemented():
    ...
    for item in [dt, td]:
        ...
        assert item.__ge__(obj) is NotImplemented
        assert item.__gt__(obj) is NotImplemented
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_datetime.py
