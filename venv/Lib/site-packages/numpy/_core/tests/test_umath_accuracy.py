<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_umath_accuracy.py
import numpy as np
import os
from os import path
import sys
    ...
    def test_validate_svml_fp16(self):
        ...
        with np.errstate(all='ignore'):
            ...
            for func in max_ulp_err:
                ...
                assert_array_max_ulp(ufunc(datafp16), ufunc(datafp32),
                        maxulp=ulp, dtype=np.float16)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_umath_accuracy.py
