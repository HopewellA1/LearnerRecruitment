<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_argparse.py
"""
...
def test_too_many_arguments_method_forwarding():
    ...
    with pytest.raises(TypeError):
        arr.mean(*args)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_argparse.py
