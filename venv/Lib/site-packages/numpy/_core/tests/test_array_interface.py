<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_array_interface.py
import sys
import pytest
import numpy as np
...
def test_cstruct(get_module):
    ...
    arr = None
    stderr.write(' ---- OK!\n\n')
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_array_interface.py
