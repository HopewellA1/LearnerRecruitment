<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_cpu_dispatcher.py
...
def test_dispatcher():
    ...
    all_sfx.append("func") # add the baseline
    assert_equal(test["all"], all_sfx)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_cpu_dispatcher.py
