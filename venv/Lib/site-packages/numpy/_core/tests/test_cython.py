<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_cython.py
...
def test_complex(install_temp):
    ...
    inc2_cfloat_struct(arr)
    assert arr[1] == (12 + 12j)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_cython.py
