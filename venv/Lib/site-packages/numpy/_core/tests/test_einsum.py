<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_einsum.py
import itertools
import sys
import platform
...
def test_overlap():
    ...
    c = np.einsum('ij,jk->ik', a, b, out=b)
    assert_equal(c, d)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_einsum.py
