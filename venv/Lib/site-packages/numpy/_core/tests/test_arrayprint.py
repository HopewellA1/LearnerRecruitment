<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_arrayprint.py
import sys
import gc
...
def test_scalar_void_float_str():
    ...
    scalar = np.void((1.0, 2.0), dtype=[('f0', '<f8'), ('f1', '>f4')])
    assert str(scalar) == "(1.0, 2.0)"
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_arrayprint.py
