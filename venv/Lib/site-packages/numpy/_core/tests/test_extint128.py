<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_extint128.py
import itertools
import contextlib
import operator
import pytest
...
def test_ceildiv_128_64():
    with exc_iter(INT128_VALUES, INT64_POS_VALUES) as it:
        for a, b in it:
            ...
            if c != d:
                assert_equal(d, c)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_extint128.py
