<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_hashtable.py
import pytest
...
def test_identity_hashtable(key_length, length):
    ...
    with pytest.raises(RuntimeError):
        identityhash_tester(key_length, keys_vals)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_hashtable.py
