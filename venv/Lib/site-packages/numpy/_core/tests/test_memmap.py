<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_memmap.py
import sys
import os
import mmap
import pytest
...
class TestMemmap:
    ...
    def test_shape_type(self):
        ...
        memmap(self.tmpfp, shape=list(self.shape), mode='w+')
        memmap(self.tmpfp, shape=asarray(self.shape), mode='w+')
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_memmap.py
