<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_dtype.py
import sys
import operator
import pytest
import ctypes
...
def test_creating_dtype_with_dtype_class_errors():
    ...
    with pytest.raises(TypeError, match="Cannot convert np.dtype into a"):
        np.array(np.ones(10), dtype=np.dtype)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_dtype.py
