<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_nep50_promotions.py
"""
...
def test_oob_creation(sctype, create):
    ...
    assert create(sctype, iinfo.min) == iinfo.min
    assert create(sctype, iinfo.max) == iinfo.max
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_nep50_promotions.py
