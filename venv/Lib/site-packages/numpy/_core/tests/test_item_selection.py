<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_item_selection.py
import sys
...
class TestPut:
    ...
    def test_empty(self, dtype, mode):
        ...
        np.put(arr, [1, 2, 3], [])
        assert_array_equal(arr, arr_copy)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_item_selection.py
