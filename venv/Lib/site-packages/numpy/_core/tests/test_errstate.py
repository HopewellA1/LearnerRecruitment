<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_errstate.py
import pytest
import sysconfig
...
class TestErrstate:
    ...
    def test_asyncio_safe(self):
        ...
        assert np.geterr()["invalid"] == "warn"  # the default
        loop.close()
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_errstate.py
