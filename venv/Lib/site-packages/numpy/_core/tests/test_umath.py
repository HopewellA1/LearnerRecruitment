<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_umath.py
import platform
import warnings
import fnmatch
import itertools
...
class TestAdd_newdoc_ufunc:
    ...
    def test_string_arg(self):
        assert_raises(TypeError, ncu._add_newdoc_ufunc, np.add, 3)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_umath.py
