<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_simd.py
    ...
    for sfxes, cls in tests_registry.items():
        for sfx in sfxes:
            ...
            if skip_m:
                pytest.mark.skip(reason=skip_m)(tcls)
            globals()[tcls.__name__] = tcls
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_simd.py
