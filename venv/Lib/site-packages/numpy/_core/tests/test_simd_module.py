<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_simd_module.py
import pytest
...
class Test_SIMD_MODULE:
    ...
    def test_compare(self):
        ...
        for i in data_range:
            assert vdata[i] == data_range[i]
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_simd_module.py
