<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_scalarprint.py
...
class TestRealScalars:
    ...
    def float64_vs_python(self):
        ...
        assert_equal(repr(np.float64(0.1)), repr(0.1))
        assert_(repr(np.float64(0.20000000000000004)) != repr(0.2))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_scalarprint.py
