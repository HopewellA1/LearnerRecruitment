<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_regression.py
import copy
import sys
import gc
import tempfile
...
class TestRegression:
    ...
    def test_vectorize_fixed_width_string(self):
        ...
        res = np.vectorize(f, otypes=[arr.dtype])(arr)
        assert res.dtype == "U30"
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_regression.py
