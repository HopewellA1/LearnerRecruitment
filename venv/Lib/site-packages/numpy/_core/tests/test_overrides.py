<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_overrides.py
import inspect
import sys
import os
import tempfile
...
def test_function_like():
    ...
    with pytest.raises(TypeError, match="unsupported operand type"):
        bound()
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_overrides.py
