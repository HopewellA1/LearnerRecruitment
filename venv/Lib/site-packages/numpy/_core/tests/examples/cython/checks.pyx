<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/examples/cython/checks.pyx
...
def inc2_cfloat_struct(cnp.ndarray[cnp.cfloat_t] arr):
    ...
    arr[1].real = arr[1].real + 1
    arr[1].imag = arr[1].imag + 1
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/examples/cython/checks.pyx
