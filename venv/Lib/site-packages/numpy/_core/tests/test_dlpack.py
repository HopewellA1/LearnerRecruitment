<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_dlpack.py
import sys
import pytest
...
class TestDLPack:
    ...
    def test_size1dims_arrays(self):
        ...
        y = np.from_dlpack(x)
        assert_array_equal(x, y)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_dlpack.py
