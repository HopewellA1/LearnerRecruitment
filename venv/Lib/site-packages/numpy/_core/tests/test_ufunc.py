<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_ufunc.py
import warnings
import itertools
import sys
import ctypes as ct
...
class TestLowlevelAPIAccess:
    ...
    def test_long_arrays(self):
        ...
        tc = np.cos(t)
        assert_equal(tc[0][0], tc[28][414])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_ufunc.py
