<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_print.py
import sys
...
class TestCommaDecimalPointLocale(CommaDecimalPointLocale):
    ...
    def test_locale_longdouble(self):
        assert_equal(str(np.longdouble('1.2')), str(float(1.2)))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_print.py
