<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_getlimits.py
...
def test_plausible_finfo():
    ...
    for ftype in np._core.sctypes['float'] + np._core.sctypes['complex']:
        ...
        assert_(info.minexp < -1)
        assert_(info.maxexp > 1)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_getlimits.py
