<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_custom_dtypes.py
import sys
...
def test_is_numeric():
    assert SF._is_numeric
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_custom_dtypes.py
