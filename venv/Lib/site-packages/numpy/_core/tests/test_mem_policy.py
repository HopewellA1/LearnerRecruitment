<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_mem_policy.py
import asyncio
import gc
import os
import sys
...
def test_owner_is_base(get_module):
    ...
    with pytest.warns(UserWarning, match='warn_on_free'):
        ...
        gc.collect()
        gc.collect()
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_mem_policy.py
