<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_scalar_methods.py
"""
...
class TestBitCount:
    ...
    def test_bit_count(self):
        for exp in [10, 17, 63]:
            ...
            assert np.uint64(a ^ 63).bit_count() == 7
            assert np.uint64((a - 1) ^ 510).bit_count() == exp - 8
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_scalar_methods.py
