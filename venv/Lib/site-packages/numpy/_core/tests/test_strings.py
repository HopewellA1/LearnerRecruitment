<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_strings.py
import sys
import pytest
...
class TestReplaceOnArrays:
    ...
    def test_replace_broadcasting(self, dt):
        ...
        r3 = np.strings.replace(a, ["0", "0,0", "0,0,0"], "X")
        assert_array_equal(r3, np.array(["X,X,X", "X,0", "X"], dtype=dt))
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_strings.py
