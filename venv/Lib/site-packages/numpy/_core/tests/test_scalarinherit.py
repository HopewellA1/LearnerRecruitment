<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_scalarinherit.py
...
class TestCharacter:
    ...
    def test_char_repeat(self):
        ...
        assert_(np_s * 5 == res_s)
        assert_(np_u * 5 == res_u)
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_scalarinherit.py
