<<<<<<< HEAD:venv/Lib/site-packages/numpy/_core/tests/test_shape_base.py
import pytest
import numpy as np
...
def test_block_dispatcher():
    ...
    # don't recurse into non-lists
    assert_equal(list(_block_dispatcher((a, b))), [(a, b)])
>>>>>>> 88e2e56b8b4d2bdf087a4d11249f6993dbacf836:env/Lib/site-packages/numpy/_core/tests/test_shape_base.py
